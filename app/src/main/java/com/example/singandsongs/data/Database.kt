...
@androidx.room.Database(entities = [Canto::class, PlayList::class, CantoPlayListCrossRef::class, Content::class, Place::class, Playing::class, Day::class], version = 45, exportSchema = false)
